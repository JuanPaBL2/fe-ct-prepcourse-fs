...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   let contener = objetoUsuario.hasOwnProperty("email");
   return contener;
}
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   return totalLikes; // Devolvemos la suma total de likes
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto["calcularPrecioDescuento"] = function() {
      let multiplicacion = objetoProducto.precio * objetoProducto.porcentajeDeDescuento;
      let precioConDescuento = objetoProducto.precio - multiplicacion;
